...
namespace guideXOS {
    /// <summary>
    /// Provides system call API for user mode applications and GXM executables.
    /// Handles function pointer resolution and system call dispatching.
    /// </summary>
    public static unsafe class API {
        /// <summary>
        /// Resolves a system call by name and returns a function pointer to the implementation.
        /// </summary>
        /// <param name="name">The name of the system call to resolve.</param>
        /// <returns>A function pointer to the requested system call, or null if not found.</returns>
